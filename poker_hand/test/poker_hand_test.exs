...
defmodule PokerHandTest do
  ...
  test "Highest straight flush wins 001" do
    assert PokerHand.compare("4S 5H 6H TS AC", "9S 8H 6H TS AC") == @result.loss
  end

  test "Highest straight flush wins 000" do
    assert PokerHand.compare("4S 5H 6H TS AC", "TS KS 5S 9S AC") == @result.loss
  end
